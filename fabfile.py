...
def celery():
    ...
    install_requirements()
    migrate()
    local('celery worker -A todo_backend -B -l INFO --concurrency=2')
...
def dev():
    ...
    env.remote = 'origin'
    env.branch = 'master'
    env.hosts = ['dev.todo_backend.com']
    env.dotenv_path = '/home/ubuntu/dev/todo_backend/.env'
...
def qa():
    ...
    env.remote = 'origin'
    env.branch = 'qa'
    env.hosts = ['qa.todo_backend.com']
    env.dotenv_path = '/home/ubuntu/qa/todo_backend/.env'
    env.config_setter = fab.run
...
def prod():
    ...
    env.remote = 'origin'
    env.branch = 'prod'
    env.hosts = ['prod.todo_backend.com']
    env.dotenv_path = '/home/ubuntu/prod/todo_backend/.env'
    env.config_setter = fab.run
