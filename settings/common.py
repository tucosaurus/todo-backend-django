"""Django settings for todo-backend project.
...
APPS_DIR = ROOT_DIR.path('todo_backend')
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'todo_backend.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'todo_backend.users.auth.backends.UserTokenAuthentication',

        # Mainly used for api debug.
        'rest_framework.authentication.SessionAuthentication',
    ),
    'EXCEPTION_HANDLER': 'todo_backend.base.exceptions.exception_handler',
}
...
SITE_NAME = env("SITE_NAME", default='todo-backend')
...
FRONTEND_SITE_NAME = env('FRONTEND_SITE_NAME', default='todo-backend')
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL',
                         default='todo-backend <support@todo_backend.com>')
EMAIL_SUBJECT_PREFIX = env('EMAIL_SUBJECT_PREFIX', default='[todo-backend] ')
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres://localhost/todo_backend'),
}
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                'todo_backend.base.context_processors.site_settings',
...
CSRF_FAILURE_VIEW = 'todo_backend.base.views.csrf_failure'
...
def get_release():
    import todo_backend
    release = todo_backend.__version__
    return release
